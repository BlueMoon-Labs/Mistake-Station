...
/obj/item/paper/fluff/letter/cap45 //Little passive agressive? Maybe
	...
	note_info = "Due to miuse of the 45 Caliber side arm known as the Mk. 58 Enforcer, the Captain will no longer be supplied with it. In order to obtain it, you must requesition it through cargo. Please and thank you - Central Command Logistics"
