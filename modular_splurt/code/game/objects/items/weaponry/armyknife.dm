/obj/item/armyknife
	...
	throw_speed = 4
	throw_range = 5
	attack_verb_simple = list("whacked")
...
/obj/item/armyknife/screw
	...
	throw_speed = 4
	throw_range = 5
	attack_verb_simple = list("stabbed", "screwed", "jabbed","whacked")
...
/obj/item/armyknife/cutter
	...
	throw_speed = 4
	throw_range = 5
	attack_verb_simple = list("cut", "whacked")
	hitsound = 'sound/weapons/bladeslice.ogg'
	toolspeed = 1.1
...
/obj/item/armyknife/blade
	...
	throw_range = 5
	hitsound = 'sound/weapons/bladeslice.ogg'
	attack_verb_simple = list("stabbed", "slashed", "cut")
