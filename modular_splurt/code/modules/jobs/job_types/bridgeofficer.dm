/datum/job/bridgeofficer
	...
	important_text = "<font color='red'>Bridge Officer: You are here to assist the bridge staff with whatever they need. You have very limited access. You are not Secuirty and you are not in the line of secceustion. You have no power, listen to the Captain and the HOP.</font>"
