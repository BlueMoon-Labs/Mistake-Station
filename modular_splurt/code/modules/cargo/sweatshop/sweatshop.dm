...
/obj/item/carpentry/handsaw
	...
	attack_verb_simple = list("slashed", "sawed")
...
/obj/item/carpentry/hammer
	...
	attack_verb_simple = list("bonked", "nailed")
...
/obj/item/carpentry/glue
	...
	attack_verb_simple = list("glued", "coughed")
...
/obj/item/carpentry/borer
	...
	attack_verb_simple = list("bored", "drilled")
...
/obj/item/carpentry/sandpaper
	...
	attack_verb_simple = list("sanded", "licked")
...
/obj/item/nails
	...
	attack_verb_simple = list("nailed", "screwed")
...
/obj/item/cushion
	...
	sharpness = FALSE
	w_class = WEIGHT_CLASS_NORMAL
	attack_verb_simple = list("thomped", "thwacked")
