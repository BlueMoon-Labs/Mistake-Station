...
/obj/item/processed/wood
	...
	sharpness = FALSE
	attack_verb_simple = list("slapped", "thunked")
...
/obj/item/processed/wood/peg
	...
	attack_verb_simple = list("donked", "thunked")
...
/obj/item/processed/wood/gluepeg
	...
	force = 1
	w_class = WEIGHT_CLASS_TINY
	attack_verb_simple = list("pegged", "thunked")
...
/obj/item/processed/wood/glueblock
	...
	force = 2
	w_class = WEIGHT_CLASS_SMALL
	attack_verb_simple = list("blocked", "thunked")
