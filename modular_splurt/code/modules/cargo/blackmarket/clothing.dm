/datum/market_item/syndi/clothing/ds_hardsuit
	price = 0
	stock = 0
	availability_prob = 0	//Zeroing this out so it can't be used at all
//normal

/datum/market_item/clothing/stalker
...
/datum/market_item/clothing/military
...
/datum/market_item/syndi/clothing/tactical
...
/datum/market_item/syndi/clothing/tacticalskirt
...
/datum/market_item/syndi/clothing/fullred_spacesuit_set
...
/datum/market_item/syndi/clothing/fullred_spacesuit_set/spawn_item(loc)
...
/datum/market_item/syndi/clothing/fullgreen_spacesuit_set
...
/datum/market_item/syndi/clothing/fullgreen_spacesuit_set/spawn_item(loc)
	var/obj/item/storage/box/B = ..()
	B.name = "Spacesuit Box"
	B.desc = "It has a NT logo crossed with marker on it."
