...
/obj/machinery/vending/security
	...
	product_ads = "Раскалывай коммунистические черепа!;Разбей несколько голов!;Не забывайте - вред есть благо!;Ваше оружие прямо здесь.;Наручники!;Стоять, отморозок!;Не бей меня, брат!;Бей их, брат.;Почему бы не съесть пончик?"
	vend_reply = "Удачной службы!"
	icon_state = "sec"
	icon_deny = "sec-deny"
	panel_type = "panel6"
