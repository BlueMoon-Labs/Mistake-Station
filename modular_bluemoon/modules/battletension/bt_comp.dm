...
/datum/component/battletension/proc/is_enabled()
	var/mob/owner = parent
	if((!owner || !owner.client || !(owner.client.prefs.read_preference(/datum/preference/toggle/sound_jukebox))) && !SSbtension.forced_tension)
		qdel(src)
		return FALSE
	return TRUE
...
/datum/component/battletension/proc/get_sound_list()
	...
	*/
	...
	var/list/bm_prikol = list(  'config/battle_music/prikol/Battlefield.ogg',
								'config/battle_music/prikol/gladiator.ogg',
								'config/battle_music/prikol/Ketchup.ogg',
								'config/battle_music/prikol/HIJACKED_GOVNOVOZ.ogg')
	var/list/bm_techno = list(  'config/battle_music/techno/03 NARC.ogg',
								'config/battle_music/techno/Carpenter Brut - Roller Mobster.ogg',
								'config/battle_music/techno/M O O N - Hydrogen.ogg',
								'config/battle_music/techno/Blood Stain - Remi Gallego.ogg',
								'config/battle_music/techno/Street Cleaner - Murdercycle.ogg',
								'config/battle_music/techno/Overpass.ogg',
								'config/battle_music/techno/Downstairs - Funeral Director.ogg',
								'config/battle_music/techno/Alert! - Instrumental - Vulta.ogg',
								'config/battle_music/techno/Maciej Niedzielski - Old Military Base.ogg')
	var/list/bm_touhou = list(  'config/battle_music/touhou/80sspark.ogg',
								'config/battle_music/touhou/badapple.ogg',
								'config/battle_music/touhou/Galaxy Collapse.ogg',
								'config/battle_music/touhou/Night of Bad Times.ogg',
								'config/battle_music/touhou/owenwasher.ogg')
	var/list/bm_mortal = list(  'config/battle_music/mortal/unstoppable.ogg')
	var/list/bm_nazist = list(  'config/battle_music/nazist/German Military Marches - Lore, Lore, Lore.ogg')
