/datum/customer_data
	speech_sound = null
	var/list/vocal_bark_id = list("squeak")
...
/datum/customer_data/american
	...
	vocal_bark_id = list("Braum", "Malfurion", "Medivh", "Ozara", "Pudge")
...
/datum/customer_data/italian
	...
	vocal_bark_id = list("Barbas", "Clockwerk", "Muradin", "Rasil")
...
/datum/customer_data/french
	...
	speech_sound = null
	vocal_bark_id = list("Archmage", "Awilo", "Belloc", "Priest")
...
/datum/customer_data/japanese
	...
	speech_sound = null
	vocal_bark_id = list("Ahri", "Chromie", "Eudora", "Luna", "Qiyana")
...
/datum/customer_data/japanese/salaryman
	...
	speech_sound = null
	vocal_bark_id = list("Malkoran", "Narrator", "Overseer", "Rhombus")
...
/datum/customer_data/mexican
	...
	speech_sound = null
	vocal_bark_id = list("Barney", "Batrider", "Putricide", "Soldier")
...
/datum/customer_data/british
	...
	speech_sound = null
	vocal_bark_id = list("Ebony", "Ekko", "Emperor", "Loxley")
...
/datum/custom_order/reagent/get_order_line(datum/venue/our_venue)
	return "Я буду [reagents_needed]u с [initial(reagent_type.name)]"
...
/mob/living/simple_animal/robot_customer/Initialize(mapload, datum/customer_data/customer_data, datum/venue/attending_venue)
	...
	if(customer_info)
		vocal_bark_id = pick(customer_info.vocal_bark_id)
