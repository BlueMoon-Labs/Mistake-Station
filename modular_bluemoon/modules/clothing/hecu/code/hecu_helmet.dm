/obj/item/clothing/head/helmet/hecu
	...
	icon = 'modular_bluemoon/modules/clothing/hecu/icons/hecucloth.dmi'
	worn_icon = 'modular_bluemoon/modules/clothing/hecu/icons/hecumob.dmi'
	worn_icon_muzzled = 'modular_bluemoon/modules/clothing/hecu/icons/hecumob_muzzled.dmi'
