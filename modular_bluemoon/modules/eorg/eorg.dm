...
/proc/process_eorg_teleport()
	...
	var/static/list/EORG_outfits_rare = list(\
		...
		/datum/outfit/centcom/spec_ops, /datum/outfit/mobster, /datum/outfit/pirate/nri/marine)
	var/static/list/EORG_outfits_rare_survivor = list(\
		/datum/outfit/butler, /datum/outfit/prisoner, /datum/outfit/job/assistant, /datum/outfit/ashwalker)
