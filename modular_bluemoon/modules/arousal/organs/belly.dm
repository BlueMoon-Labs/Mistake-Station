...
/obj/item/organ/external/genital/belly/build_from_dna(datum/dna/DNA, associated_key)
	...
	toggle_visibility(DNA.features["belly_visibility"], FALSE)
	if(DNA.features["belly_stuffing"])
		toggle_visibility(GEN_ALLOW_EGG_STUFFING, FALSE)

	return ..()

/obj/item/organ/external/genital/belly/build_from_accessory(datum/sprite_accessory/genital/accessory, datum/dna/DNA, mob/living/carbon/human/H)
