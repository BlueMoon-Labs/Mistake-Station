...
/datum/preference/color/character_runechat_color/apply_to_human(atom/target, value)
...
/datum/preference/choiced/character_bark/apply_to_human(mob/living/carbon/human/character, value, mob/user)
	var/bark_id = GLOB.bark_list[value]
	if(bark_id)
		var/datum/bark/bark_type = new bark_id
		character.selected_bark = bark_type
