...
/obj/item/clothing/sextoy/vibrator/attack(mob/living/carbon/human/target, mob/living/carbon/human/user)
	...
	switch(user.zone_selected) //to let code know what part of body we gonna vibe
		if(BODY_ZONE_PRECISE_GROIN)
			...
			if((vagina && penis) && (vagina.genital_flags == GENITAL_THROUGH_CLOTHES && penis.genital_flags == GENITAL_THROUGH_CLOTHES || target.is_bottomless()))
			...
			else if(vagina && (vagina.genital_flags == GENITAL_THROUGH_CLOTHES || target.is_bottomless()))
			...
			else if(penis && (penis.genital_flags == GENITAL_THROUGH_CLOTHES || target.is_bottomless()))
