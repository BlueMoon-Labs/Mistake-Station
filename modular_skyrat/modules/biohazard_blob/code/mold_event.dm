...
/datum/round_event/mold/announce(fake)
	...
	priority_announce("Confirmed outbreak of level 6 biohazard aboard [station_name()]. Весь персонал должен противостоять эпидемии.", "Биологическая Тревога", ANNOUNCER_OUTBREAK6)
