...
GLOBAL_LIST_INIT(arachnid_first, world.file2list("strings/names/moth_first.txt"))
GLOBAL_LIST_INIT(arachnid_last, world.file2list("strings/names/moth_last.txt"))
