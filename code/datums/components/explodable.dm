...
/datum/component/explodable/proc/is_hitting_zone(def_zone)
	...
	if(ishuman(wearer))
		...
		worn_items += list(human_wearer.wear_suit, human_wearer.w_uniform, human_wearer.belt, human_wearer.s_store, human_wearer.wear_id, human_wearer.w_socks, human_wearer.w_underwear, human_wearer.w_undershirt, human_wearer.ears_extra) //BlueMoon edit. Нахуй это нужно? Не знаю.
