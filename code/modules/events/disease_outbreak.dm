...
/datum/round_event/disease_outbreak/announce(fake)
	priority_announce("Подтвержденная вспышка Вирусной Биологической Опасности Седьмого Уровня на борту [station_name()]. Весь персонал должен противостоять эпидемии.", "[illness_type] Тревога", ANNOUNCER_OUTBREAK7)
