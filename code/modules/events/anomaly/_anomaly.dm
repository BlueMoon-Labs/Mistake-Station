...
/datum/round_event/anomaly/announce(fake)
	priority_announce("Energetic flux wave detected on [ANOMALY_ANNOUNCE_DANGEROUS_TEXT] [impact_area.name].", "Аномальная Тревога", ANNOUNCER_ANOMALIES) //SKYRAT EDIT CHANGE
