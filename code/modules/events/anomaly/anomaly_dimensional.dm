...
/datum/round_event/anomaly/anomaly_dimensional/announce(fake)
	priority_announce("Обнаружена Локационная Блюспейс-Нестабильность на [ANOMALY_ANNOUNCE_MEDIUM_TEXT] [impact_area.name].", "Аномальная Тревога", ANNOUNCER_ANOMALIES) //SKYRAT EDIT CHANGE
