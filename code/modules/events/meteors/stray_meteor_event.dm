...
/datum/round_event/stray_meteor/announce(fake)
	if(GLOB.meteor_list)
		...
		priority_announce("Our [sensor_name] sensors have detected an incoming signature approaching [GLOB.station_name]. Please brace for impact.", "Метеоритная Тревога")
