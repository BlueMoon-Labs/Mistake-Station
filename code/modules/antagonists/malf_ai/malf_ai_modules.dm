...
/datum/action/innate/ai/nuke_station/proc/set_up_us_the_bomb(mob/living/owner)
	...
	if (owner_AI.stat != DEAD)
		priority_announce("Hostile runtimes detected in all station systems, please deactivate your AI to prevent possible damage to its morality core.", "Аномальная Тревога", ANNOUNCER_AIMALF)
