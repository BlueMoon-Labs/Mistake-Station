...
/datum/job/security_officer/proc/setup_department(mob/living/carbon/human/spawning, client/player_client)
	...
	if(ears)
		if(spawning.ears)
			qdel(spawning.ears)
		spawning.equip_to_slot_or_del(new ears(spawning),ITEM_SLOT_EARS_LEFT)
...
/datum/outfit/job/security
	...
	head = /obj/item/clothing/head/beret/sec //СУКА, БЛЯДЬ. - Original: /obj/item/clothing/head/security_garrison
