...
/mob/living/carbon/human/add_blood_DNA(list/blood_DNA_to_add, list/datum/disease/diseases)
	...
	//BlueMoon edit
		...
		w_underwear.add_blood_DNA(blood_DNA_to_add)
		update_inv_w_underwear()
	else if(w_socks)
		w_socks.add_blood_DNA(blood_DNA_to_add)
		update_inv_w_socks()
	else if(w_undershirt)
		w_undershirt.add_blood_DNA(blood_DNA_to_add)
		update_inv_w_undershirt()
	else if(wrists)
		wrists.add_blood_DNA(blood_DNA_to_add)
		update_inv_wrists()
	//
	if(gloves)
