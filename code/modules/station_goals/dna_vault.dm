...
/datum/station_goal/dna_vault/get_report()
	return list(
		"<blockquote>Наши системы долгосрочного прогнозирования указывают на 99-процентную вероятность межсистемного катаклизма в ближайшем будущем.",
		...
		"",
		"Основа для хранилища доступна к заказу в карго.</blockquote>",
	).Join("\n")
