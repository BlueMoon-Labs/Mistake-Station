...
/datum/dynamic_ruleset/midround/malf/execute()
	...
	if(prob(MALF_ION_PROB))
		priority_announce("Ion storm detected near the station. Please check all AI-controlled equipment for errors.", "Аномальная Тревога", ANNOUNCER_IONSTORM)
...
/datum/dynamic_ruleset/midround/from_ghosts/space_dragon/generate_ruleset_body(mob/applicant)
	...
	priority_announce("Похоже, приближается огромная форма жизни с признаками магии к [station_name()], пожалуйста, приготовьтесь.", "Вторжение на Борт")
	return S
