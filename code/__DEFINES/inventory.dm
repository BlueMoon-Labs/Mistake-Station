...
#define ITEM_SLOT_ON_BODY (ITEM_SLOT_ICLOTHING | ITEM_SLOT_OCLOTHING | ITEM_SLOT_GLOVES | ITEM_SLOT_EYES | \
	ITEM_SLOT_MASK | ITEM_SLOT_HEAD | ITEM_SLOT_FEET | ITEM_SLOT_ID | ITEM_SLOT_BELT | ITEM_SLOT_BACK | ITEM_SLOT_NECK | \
	ITEM_SLOT_UNDERWEAR | ITEM_SLOT_SOCKS | ITEM_SLOT_SHIRT | ITEM_SLOT_SHIRT | ITEM_SLOT_EARS_LEFT | ITEM_SLOT_EARS_RIGHT | ITEM_SLOT_WRISTS )
