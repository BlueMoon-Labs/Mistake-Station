...
/// Macro for automatically getting the volume of a storage item from its max_w_class and max_total_storage.
#define AUTO_SCALE_STORAGE_VOLUME(w_class, max_total_storage)		(AUTO_SCALE_VOLUME(w_class) * (max_total_storage / w_class))
