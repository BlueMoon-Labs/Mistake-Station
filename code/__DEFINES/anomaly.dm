...
#define ANOMALY_ANNOUNCE_MEDIUM_TEXT "сканерах большой дальности. Ожидаемое место:"
...
///Let them know how far away the anomaly is
#define ANOMALY_ANNOUNCE_HARMFUL_TEXT "сканерах большой дальности. Ожидаемое место:"
...
///Let them know how far away the anomaly is
#define ANOMALY_ANNOUNCE_DANGEROUS_TEXT "сканерах большой дальности. Ожидаемое место:"
