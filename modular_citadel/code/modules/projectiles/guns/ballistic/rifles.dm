...
/obj/projectile/bullet/cflechetteap	//shreds armor but no wounds
	name = "flechette (armor piercing)"
	damage = 15
	armour_penetration = 100
	wound_bonus = -100

/obj/projectile/bullet/cflechettes		//causes wounds fast but is heavily countered by armor
...
/obj/projectile/bullet/cflechetteshredder	//you only get this with a 30TC bundle,5 magazines, as such this should be the superior ammotype
...
/obj/item/ammo_casing/caseless/flechetteshredder
	...
	projectile_type = /obj/projectile/bullet/cflechetteshredder
...
/obj/item/gun/ballistic/automatic/AM4B/Initialize()
	. = ..()
