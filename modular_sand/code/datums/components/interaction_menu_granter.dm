...
/datum/component/interaction_menu_granter/ui_data(mob/user)
	...
	//Getting char prefs
		...
		.["noncon_pref"] = 			prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
		.["vore_pref"] = 			prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
		.["extreme_pref"] = 		prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
		.["extreme_harm"] = 		prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
		.["unholy_pref"] =			prefs.read_preference(/datum/preference/toggle/master_erp_preferences)

	//Getting preferencesoggle
		...
		.["vore_examine"] = 		prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
		.["medihound_sleeper"] =	prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
		.["eating_noises"] = 		prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
		.["digestion_noises"] =		prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
		.["trash_forcefeed"] = 		prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
		.["forced_fem"] = 			prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
		.["forced_masc"] = 			prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
		.["hypno"] = 				prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
		.["bimbofication"] = 		prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
		.["breast_enlargement"] = 	prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
		.["penis_enlargement"] =	prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
		.["butt_enlargement"] =		prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
		.["belly_inflation"] = 		prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
		.["never_hypno"] = 			prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
		.["no_aphro"] = 			prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
		.["no_ass_slap"] = 			prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
		.["no_auto_wag"] = 			prefs.read_preference(/datum/preference/toggle/master_erp_preferences)
