	...
	if(istype(I, /obj/item/clothing/accessory/ring))
		...
		if(dummy_thick)
			...
			for(var/obj/item/clothing/accessory/attached_accessory in attached_accessories)
				...
				if(!polychromic)
					var/mutable_appearance/accessory_overlay = mutable_appearance(attached_accessory.worn_icon, attached_accessory.icon_state || attached_accessory.icon_state, ABOVE_HUD_LAYER)
					accessory_overlay.alpha = attached_accessory.alpha
					accessory_overlay.color = attached_accessory.color
					accessory_overlays += accessory_overlay
				else
					polychromic.apply_worn_overlays(attached_accessory, FALSE, attached_accessory.worn_icon, attached_accessory.icon_state || attached_accessory.icon_state, NONE, accessory_overlays)
